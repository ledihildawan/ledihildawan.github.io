...
(function () {
  var chips = Array.prototype.slice.call(document.querySelectorAll('.cc-project-avatar[data-project-title], .cc-shipped-chip[data-project-title]'));
  ...
  function show(chip) {
    ...
    var stack = (chip.getAttribute('data-project-stack') || '').split(',').map(function (s) { return s.trim(); }).filter(Boolean);
